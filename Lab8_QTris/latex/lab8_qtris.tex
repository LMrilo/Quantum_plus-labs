...
scoring overlay on the eight lines. Its \textbf{Watch a sample game} tab replays one
curated game step by step --- deal, mulligan, twenty cards, the dice sweep with the
printed rows, scoring --- with a caption for every step; it is optional, and no
substitute for playing. Its \textbf{Sandbox} tab is a single cell with a
